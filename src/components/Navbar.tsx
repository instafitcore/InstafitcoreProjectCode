...
export default function FullNavbar() {
  ...
  /* This ensures the white background goes all the way to the top edge */
  pt-0 
`}>
        {/* Add a wrapper div inside header to handle the safe area padding */}
        <div className="pt-[env(safe-area-inset-top)]">
          <div className="flex max-w-7xl mx-auto px-4 py-4 md:py-5 items-center gap-4 md:gap-6"> <Link href="/site" className="flex items-center gap-1 shrink-0">
            {/* Logo Icon */}
        ...
        <div className={`fixed inset-0 z-[100] bg-white transition-transform ${mobileOpen ? "translate-x-0" : "translate-x-full"} lg:hidden`}>
          {/* Ensure the close button and "Menu" text don't sit under the clock */}
          <div className="flex justify-between items-center border-b p-4 pt-[calc(env(safe-area-inset-top)+1rem)]">
